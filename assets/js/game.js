...
var fightOrSkip = function() {
   ...
   if (promptFight === "" || promptFight === null) {
     window.alert("You need to provide a valid answer! Please trt again.");
     return fightOrSkip();
   }
...
// fight each enemy-robot by looping over them and fighting them one at a time
  ...
  // after loop ends, we either out of playerHealth or enemies to fight, so run the endGame function
  endGame();
};  
